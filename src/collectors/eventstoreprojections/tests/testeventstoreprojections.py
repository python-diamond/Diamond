...
class TestEventstoreProjectionsCollector(CollectorTestCase):
    ...
    def test_should_work_with_real_data(self, publish_mock, urlopen_mock):
        ...
        metrics = {
            ...
            'projections._stream_by_category.eventsProcessedAfterRestart': 0,
            'projections._stream_by_category.bufferedEvents': 0,
            'projections._stream_by_category.coreProcessingTime': 0,
            'projections._stream_by_category.epoch': -1,
            'projections._stream_by_category.version': 0,
            'projections._stream_by_category.progress': -1.0,
            'projections._stream_by_category.status': 0,
            'projections._stream_by_category.writePendingEventsBeforeCheckpoint': 0,
            'projections._stream_by_category.partitionsCached': 1,
            'projections._stream_by_category.writesInProgress': 0,
            'projections._stream_by_category.readsInProgress': 0,
            'projections._stream_by_category.writePendingEventsAfterCheckpoint': 0,
